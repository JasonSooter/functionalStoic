...
Written #🗓️/2026/08/02. The problem is not the wishlist, it is that 33 books are open at once.

### The Arithmetic

| | |
|---|---|
| Pace so far | 20 books in 213 days = **10.7 days per book** |
| Projected at that pace | **34 books** — six short |
| Required | 20 books in 151 days = **7.5 days per book** |
| Speed-up needed | **41% faster** |
| My 2024 and 2025 pace | 8.9 days per book — I have never read this fast |

I cannot get to 40 by reading harder. I get there by not starting anything new and converting what is already open. A half-read book is the cheapest finish available.

### Four States, Not Two

- **`#📚/status/currently-reading`** — genuinely in rotation. Target **6–8 books, not 33**
- **`#📚/status/paused`** — deliberately set down, will return. The missing state, and where most of the shelf belongs. Honest, and it clears the decision without declaring failure. Mirror as a `paused` tag in StoryGraph
- **`#📚/status/did-not-finish`** — dead. Orientalism, Meditations for Mortals, Good Anger, Relativity, Slow Birding, Saved in Time
- **`#📚/status/reference`** — never "finished", only consulted. [[Great Short Books]], [[Engineering in Plain Sight]], Fluent Forever, Modern German Pronunciation, German - How to Speak and Write It. These should not sit on the active shelf at all

Protected exception: [[Meditations]] and 365 Tao are **daily readers that complete on 31 December**. I did exactly this with [[The Daily Stoic]] in 2024 — started 13 Jan, finished 25 Dec. Leave them running. Two books that land in December.

### Tier 1 — Short and Already Started → 27 Books

Highest return per hour on the whole list. Seven books, all part-read, several open for years.
...
### Tier 2 — Audio, a Separate Budget → ~33 Books

The real unlock. Audiobooks run on walks, commutes and chores, so they do not compete with page time. Six already owned or in progress.

1. Sapiens — in progress
2. In Patagonia — 8h27m, owned
3. Entangled Life — owned
4. Hot and Bothered — in progress
5. Braiding Sweetgrass — in progress
6. The Joy Luck Club — owned
7. You're Not Listening — owned

### Tier 3 — Hard Books, Budget Exactly Two → ~35 Books

Not zero. The point of the year is not only volume.

1. [[Middlemarch]] — the one I have said I am glad I am doing
2. The Silk Roads — **illustrated edition**, not the audiobook

Park [[Goethe|Faust]] and Walden as `paused`. They are good books at the wrong moment.

### Tier 4 — Top up in My Proven Lane → 40 Books

Short literary fiction, the shape I reliably finish: [[Dept. Of Speculation]], [[The Dry Heart]], [[Death in Venice]], [[Agostino]], [[Bonjour Tristesse]].

1. The Hour of the Star
2. As I Lay Dying
3. Madame Bovary / The Trial / To the Lighthouse — pick from these
4. Plus two or three more of the same size

### The Rule

**Stop opening books. Start closing them.** Tier 1 alone is 33 months of accumulated stored value. No new starts until the active shelf is under eight.

## Resources

- [Storygraph 2026 Book Challenge](https://app.thestorygraph.com/reading_challenges/dashboard/functionalstoic)
- [Politics and Prose 2026 Reading Challenge](https://app.thestorygraph.com/reading_challenges/8db481d0-3c8c-4f98-95ad-5d3e91ab52c4)
...
### Reconciled From StoryGraph #🗓️/2026/08/02

These were all `currently-reading` or `to-read` in StoryGraph and completely absent from this note. StoryGraph is the source of truth for _status_; this note is where the _reasoning_ lives. The gap was 17 books.

#### German Language & Culture

1. Modern German Pronunciation by Christopher Hall #📚/status/reference #media-type/print — started #🗓️/2026/04/14
2. German - How to Speak and Write It by Joseph Rosenberg #📚/status/reference #media-type/ebook — started #🗓️/2026/05/25
3. Fluent Forever by Gabriel Wyner #📚/status/reference #media-type/ebook — started #🗓️/2026/03/12
4. German Men Sit Down To Pee & Other Insights Into German Culture #📚/status/currently-reading #media-type/ebook — started #🗓️/2025/12/03
   - Four books in progress on German, plus a `learn-german` tag in Readwise, and none of it appeared on this list. The single largest blind spot the reconciliation found — and the most relevant thing I am doing since moving to [[Freiburg]]

#### Walking, Place & the Natural World
...
1. Revolutions - How Women Changed the World on Two Wheels by Hannah Ross #📚/status/paused #media-type/ebook — started #🗓️/2026/04/05
...
20. How Big Things Get Done #📚/status/to-read #media-type/ebook #priority/1
21. \#🗓️/2026/07/31 The Self-Driven Child by William Stixrud and Ned Johnson #📚/status/to-read #media-type/ebook #priority/1
    - Replaces _Raising Children Who Think for Themselves_, which I had added purely because I liked the title. The content did not hold up — GR 3.78, and a reviewer caught the exact flaw: it "suggest\[s] to parents how to raise children in a manner that the author considers ideal, rather than how parents and children can think for themselves."
    - This is the book that actually argues that title. GR **4.32** across **6,128** ratings. Thesis: parent as _consultant_, not controller — give kids real decisions and let them own the outcomes.
    - Grounded in self-determination theory (autonomy, competence, relatedness) rather than the 2001 media-panic framing Medhus used. Covers growth mindset, flow, and intrinsic motivation.
    - Complements rather than duplicates what I have read: [[Good Inside]] is young kids and emotional regulation; The Anxious Generation is phones and external direction; this is autonomy and control. Same problem, different mechanism.
    - Connects to [[Independence]] and [[Curiosity]]
    - ⚠️ Caveat: roughly half the book is anchored to conventional US schooling — test prep, homework, college admissions. Ned Johnson runs a test-prep company and it shows. Living in Germany, discount that half harder than a US reader would.
    - \#🗓️/2026/08/01 Timing is right, not early: the book targets school-age through teens and my three are 14, 12 and 11. This is the sweet spot for all of them at once.
...
47. \#🗓️/2026/08/03 Fortune's Formula - The Untold Story of the Scientific Betting System That Beat the Casinos and Wall Street by William Poundstone #📚/status/to-read #media-type/ebook #priority/1 #people/friends/kolt-kane
    ...
    - Pairs with [[Trillions]] as the other finance book on this list, and they cover opposite halves of the same question. Trillions is _what to own_ (the index fund, Bogle, Nate Most). This is _how much to bet_ (position sizing, ruin risk). Read Trillions first; it is the more relevant of the two to what I actually do.
    - Also sits in the biography-of-a-thing shape I reliably finish: [[Cod]], [[Wedding of the Waters - The Erie Canal and the Making of a Great Nation]], [[The Brompton - Engineering for Change]], [[Just for Fun - The Story of an Accidental Revolutionary]]. Here the "thing" is an equation.
...
49. \#🗓️/2026/08/03 Seeing Like a State by James C. Scott #📚/status/to-read #media-type/ebook #priority/1
    ...
    - Also the honest counterweight to _Abundance_ (#🗓️/2026/01/19) — same subject, opposite instinct about what high-modernist planning is for.
    - ⚠️ Caveat: academic register, and the German forestry and Tanzanian villagisation case studies run long. The first hundred pages carry most of the argument.
    - Living in [[Freiburg]] makes the _Normalbaum_ scientific-forestry chapter unusually concrete — that is literally the Schwarzwald, and the failure Scott opens with (_Waldsterben_) happened here.

```query
(tag:#📚/status/to-read OR tag:#add-book-to-read) file:-"Books Read in 2026"
```
