...
// node_modules/@quartz-community/bases-page/dist/index.js
  ...
  "node_modules/yaml/dist/schema/yaml-1.1/float.js"(exports$1) {
    ...
    var float = {
      ...
      resolve(str) {
        ...
        const dot = str.indexOf(".");
        if (dot !== -1) {
          const f22 = str.substring(dot + 1).replace(/_/g, "");
          if (f22[f22.length - 1] === "0")
            node.minFractionDigits = f22.length;
        }
        return node;
      },
      stringify: stringifyNumber.stringifyNumber
...
/* @__PURE__ */ new Set([$2.H1, $2.H2, $2.H3, $2.H4, $2.H5, $2.H6]);
/* @__PURE__ */ new Set([
  TAG_NAMES.STYLE,
  TAG_NAMES.SCRIPT,
  TAG_NAMES.XMP,
...
function render({ entries, slug: slug2, allSlugs, linkResolution }) {
  ...
  for (const entry of entries) {
    ...
    markers.push({
      title: entry.title,
      url: transformLink(slug2, entry.slug, {
        strategy: linkResolution,
        allSlugs
      }),
      lat: coords[0],
      lng: coords[1],
      color: typeof entry.properties.color === "string" ? entry.properties.color : void 0,
      flag: typeof entry.properties.flag === "string" ? entry.properties.flag : void 0,
      icon: typeof entry.properties.icon === "string" ? entry.properties.icon : void 0
    });
  }
  return /* @__PURE__ */ u2("div", { class: "geo-map-wrapper", children: markers.length === 0 ? /* @__PURE__ */ u2("div", { class: "geo-map-empty", children: "No mappable notes (missing a `coordinates` property)." }) : /* @__PURE__ */ u2("div", { class: "geo-map", "data-geo-markers": JSON.stringify(markers) }) });
}
var mapViewRegistration = {
  id: "map",
  name: "Map",
  icon: "map",
  render,
